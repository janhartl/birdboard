...
fn independent_equilibrium_market_vs_espn() -> Result<()> {
    ...
    println!(
        "Auction semantics v78: MARKET predicts future cost; Max Bid is always H-indifference, target membership never caps bidding, and off-plan bargains may be bought."
    );
    println!(
