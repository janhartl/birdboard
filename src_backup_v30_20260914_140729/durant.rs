...
impl DurantModel {
    ...
    pub fn roster_plan_with_strategy_weights(
        ...
        // Stage 1: cheap global search. The whole runtime strategy bank and the
        // whole available player pool participate, but no opponent H-indifference
        // price is solved yet.
        let static_economy =
            self.estimate_market_economy_from_totals(candidates, None, market_totals, config);
        ...
        // the displayed alternatives now compare like with like.
