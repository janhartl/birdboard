...
pub fn print_stage_relearn_plan(app: &App) {
    ...
    println!();
    println!("========================================================================");
    println!("STAGE-AWARE j RELEARN — v33");
    println!("========================================================================");
    println!(
        "deep oracle vectors          : {}",
...
pub fn train_stage_early_bank(app: &App) -> Result<()> {
    ...
    println!();
    println!("========================================================================");
    println!("STAGE-AWARE EARLY j TRAINING — v33");
    println!("========================================================================");
    println!(
...
pub fn print_stage_validation_plan(app: &App) {
    ...
    println!();
    println!("========================================================================");
    println!("STAGE-AWARE j HOLDOUT VALIDATION — v33");
    println!("========================================================================");
...
pub fn validate_stage_aware_bank(app: &App) -> Result<()> {
    ...
    println!();
    println!("========================================================================");
    println!("STAGE-AWARE j HOLDOUT TEST — v33");
    println!("========================================================================");
    ...
    let output_dir = PathBuf::from("data")
        ...
        .join("durant");
    fs::create_dir_all(&output_dir)?;
    let csv_path = output_dir.join("strategy_stage_validation_v33.csv");
